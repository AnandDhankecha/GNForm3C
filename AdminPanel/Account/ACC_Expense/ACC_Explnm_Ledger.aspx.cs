...
public partial class AdminPanel_Account_ACC_Expense_ACC_Explnm_Ledger : System.Web.UI.Page
{
    ...
    private void Search(int PageNo)
    {
        ...
        ACC_Explnm_LedgerBAL balACC_Explnm_Ledger = new ACC_Explnm_LedgerBAL();

        DataTable dt = balACC_Explnm_Ledger.SelectPage(Offset, PageRecordSize, out TotalRecords, FromDate,ToDate);
    ...
    protected void lbtnExport_Click(object sender, EventArgs e)
    {
        ...
        ACC_Explnm_LedgerBAL balACC_Explnm_Ledger = new ACC_Explnm_LedgerBAL();
        DataTable dtACC_Explnm_Ldger = balACC_Explnm_Ledger.SelectPage(Offset, PageRecordSize, out TotalReceivedRecord, FromDate,ToDate);
        if (dtACC_Explnm_Ldger != null && dtACC_Explnm_Ldger.Rows.Count > 0)
        {
            Session["ExportTable"] = dtACC_Explnm_Ldger;
